        ...
        <div class="container-fluid">
            ...
            <div class="card order-summery col-md-8 mb-4 pb-4">
                <div class="card-body text-center">
                    ...
                    <div class="row">
                        <div class="col text-right">Tilausnumero:</div>
                        <div class="col text-left order-num">1234567890</div>
                    </div>
                    <div class="row">
                    ...
                    <div class="row mb-4">
                        <div class="col text-right">Asiakkaan arvio I:</div>
                        <div class="col text-left">
                            <i class="fa fa-star on mr-2"></i>
                            <i class="fa fa-star on mr-2"></i>
                            <i class="fa fa-star on mr-2"></i>
                            <i class="fa fa-star on mr-2"></i>
                            <i class="fa fa-star on mr-2"></i>
