        ...
        <div class="container-fluid">
            ...
            <div class="row" style="width: 100%;">
                <div class="col-12">
                    ...
                    <button class="bg-light download_button primary-color-w"><i class="fa-solid fa-download"></i> Lataa
                        pohjapiirustus</button>
                    <button class="bg-light download_button primary-color-w"><i class="fa-solid fa-download"></i> Tulosta
                        QR-koodi tarrat</button>
                    <button class="bg-light download_button primary-color-w"><i class="fa-solid fa-plus"></i> Lisää uusi
                        tila</button>
                </div>
                                ...
                                <div class="container-fluid">
                                    <div class="row">
                                        ...
                                        <div class="col-4">
                                            <div class="row">
                                                <div class="col-4 p-4 pt-5">
                                                    <img style="width: 100%;" src="{{ asset('img/rectangle.png') }}"
                                                        alt="">
                                                    <div class="diamond">
                                                        <a href="javascript:void(0)" class="load-modal" title="Edit"
                                                            data-url="{{ route('shapes.edit', 22) }}">
                                        ...
                                        <div class="card offset-2 col-5 primary-color-b p-2 border-radius_6 mt-3">
                                            <h3 class="primary-text-cl textCenter-alignment pb-2">Vedä tästä haluamasi pöytä
                                                kartalle</h3>
                                            <div class="row">
                                                <div class="col-3"><img style="width: 100%;"
                                                        src="{{ asset('img/circle2.png') }}" alt=""></div>
                                                <div class="col-3"><img style="width: 100%;"
                                                        src="{{ asset('img/diamond.png') }}" alt=""></div>
                                                <div class="col-3 pb-4 pr-4 pl-4"><img
                                                        style="width: 100%; padding-left: 8px;"
                                                        src="{{ asset('img/rectangle.png') }}" alt=""></div>
                                                <div class="col-3"><img style="width: 100%;"
                                                        src="{{ asset('img/circle.png') }}" alt=""></div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="card col-3 primary-color-b p-2 border-radius_6 ml-2 mt-3">
                                            ...
                                            <div class="row">
                                                <div class="col-12" style="padding: 0px 0px 0px 75px;">
                                                    <div
                                                        style="margin-top: 10px; position: absolute; display: block; background-color: #fff; min-height: 10px; width: 100px;">
                                                    </div>
                                                </div>
                                                <div class="col-2" style="padding-left: 35px;">
                                                    <div
                                                        style="position: absolute; display: block; background-color: #fff; min-height: 100px; width: 10px;">
                                                    </div>
                                                </div>
                                                <h2 class="col-12 textCenter-alignment primary-text-cl-w"
                                                    style="margin-top: 40px;">Seinä</h2>
                                            </div>
                                        </div>
                                    </div>
                                </div>
